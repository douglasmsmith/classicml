...
%
% NOTE: from source -- confirming repitition of exercise...
...
z = (X * theta); %Adding this additional layer to conform to lecture description.
...
% "end" keyword refers to last element in matrix so we can subset the matrix
